...
**To download an OVA to import a full virtual machine, visit https://tiny.si/SamuraiWTF-4.0RC1.ova. A [video tutorial](https://www.youtube.com/watch?v=3a3qOFubfGg) is available showing how to install from OVA.
